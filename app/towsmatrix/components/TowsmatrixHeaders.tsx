                ...
                GetAllSWOT().then(value => {
                    ...
                    {                
                      ...
                      for(let i=0;i<value.length;i++)
                      {
                        ...
                        list.push(newSegment);
                        if(swotId !='0' && swotId==value[i].frameworkId)
                        {
                          title=value[i].title;
                        }
                      }
...
async function loadSelectedSegment(option: number){ 
      ...
      if(selectedSegmentId !='' && selectedSegmentId !='0')
      {
       ...
       window.location.href='/towsmatrix?swotId='+selectedSegmentId+'&rg='+option;
      }      
      else{
...
export default TowsmatrixHeader;
