  ...
  return (
    <>
      <div className="bg-bgthemeClr">
        <div className="px-1 md:px-20 lg:px:30 xl:px-52 py-10">
          <div className="bg-white w-full sm:w-[90%]  md:w-[80%] mx-auto rounded-lg my-3">
            {/* Form Section */}
            <section className="flex justify-end px-8 pt-6">  
...
<br />
Affiliate means an entity that controls, is controlled by or is under common control with a party, where &Prime;control&Prime; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.
<br />
Application refers to Edi Analytica, the software program provided by the Company.
<br />
Company (referred to as either &Prime;the Company&Prime;, &Prime;We&Prime;, &Prime;Us&Prime; or &Prime;Our&Prime; in this Agreement) refers to Pangeacons LLC, Dubai.
<br />
...
<br />
Website refers to Edi Analytica, accessible from https://edianalytica.com/
<br />
...
<br />
Usage Data may include information such as Your Device&prime;s Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers and other diagnostic data.
<br />
...
<br /><br />
Cookies can be &Prime;Persistent&Prime; or &Prime;Session&Prime; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser.
<br /><br />
...
<br />
To contact You: To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application&prime;s push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.
<br />
...
<br /><br />
If We need to rely on consent as a legal basis for processing Your information and Your country requires consent from a parent, We may require Your parent&prime;s consent before We collect and use that information.
<br /><br />
Links to Other Websites<br />
Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&prime;s site. We strongly advise You to review the Privacy Policy of every site You visit.
<br /><br />
...
<br /><br />
We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the &Prime;Last updated&Prime; date at the top of this Privacy Policy.
<br /><br />
