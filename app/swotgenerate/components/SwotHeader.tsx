...
const SwotHeader = () => {
    ...
    async function loadSelectedSegment(option: number){ 
      ...
      {
       window.location.href='/swotgenerate?frameworkId='+selectedSegmentId+'&rg='+option;
      }
      else if(frameworkId !='0')
      {
        window.location.href='/swotgenerate';
      }
      else{
  ...
  return (
    <>
      ...
      <div className="bg-white w-full sm:w-[90%]  md:w-[80%] mx-auto rounded-lg my-3">
            Generate a comprehensive Business Environmental Analysis with our trained model.
            <br />
            <span className="text-red-500">Note:</span> Either a Business Model Canvas (BMC) or Lean Canvas (LC) must be completed
            as a prerequisite.
      ...
      <div className="mobileSmallFont bg-white w-full sm:w-[90%] md:w-[80%] mx-auto rounded-lg my-3">
            ...
            >
              {selectedSegmentText || "Select Saved Canvas"}
              <svg
